          ...
          >
            <div className="relative select-none">
              ...
              {userData.profileImage === "" ? (
                ...
                >
                  <div
                    className={`text-[48px] absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-4  rounded-full ${
                      theme
                        ? "bg-black text-[#fff] border-black"
            ...
            <div className="mt-8 text-center font-medium mb-2 w-full">
              <h2 className="pb-1 capitalize whitespace-nowrap overflow-hidden w-[100%] text-ellipsis flex justify-center">
                {userData.fullName}
              ...
              <p
                className={`text-xs px-2 text-center ${
                  theme ? "text-[#ffffffd6]" : "text-[#000000a5]"
                }`}
            ...
            <div className="mb-2 select-none">
              <h2
                className={`text-center font-medium text-[#000000a5]  ${
                  theme ? "text-[#ffffffd6]" : "text-[#000000a5]"
                }`}
              >
                Followers
            ...
            <Link to="/Profile">
              <h2 className="text-[#117DD5] text-center font-bold mb-2 select-none">
                View profile
              </h2>
            </Link>
          </div>
                ...
                <Link to={`/User/${data.username}`}>
                  ...
                  >
                    ...
                    <div className="w-full">
                      <p className="text-left font-semibold whitespace-nowrap overflow-hidden w-[75%] text-ellipsis flex">
                        {data.fullName}
                        {data && data.Verify && (
                          <span className="text-[#1d9bf0] mt-1 ">
                            <VscVerifiedFilled />
