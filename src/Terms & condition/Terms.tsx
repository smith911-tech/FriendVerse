    ...
    return (
        <main className={` ${LightdarkM ? "bg-white text-black color-Toggle" : "bg-black text-[#ffffffc4]  color-Toggle"} font-Inter `}>
            ...
            <section className='pb-7'>
                ...
                <h2 className={`text-center py-10 font-bold  ${LightdarkM ? "bg-black text-white  color-Toggle" : "bg-white text-black  color-Toggle"}`}>Effective: July 11, 2023 </h2>
            </section>
            <section className='px-2 md734:px-[10%]'>
                <h2 className='font-bold text-3xl  border-b-2 pb-4'>
                    Terms of service
                </h2>
                <span >
                    <h2 className='text-xl font-extrabold'>1. Who May Use the Services</h2>
                    <p className=''>You may use the Services only if you agree to form a binding contract with us and are not a person barred from receiving services under the laws of the applicable jurisdiction. In any case, you must be at least 4 years old, to use the Services. If you are accepting these Terms and using the Services on behalf of a company, organization, government, or other legal entity, you represent and warrant that you are authorized to do so and have the authority to bind such entity to these Terms, in which case the words “you” and “your” as used in these Terms shall refer to such entity.</p>
                </span>
                <br />
                <span >
                    <h2 className='font-bold text-xl'>2. Privacy</h2>
                    <p className=''>Our <Link className='text-[#117DD5]' to='/PrivacyPolicy'> Privacy Policy </Link>describes how we handle the information you provide to us when you use our Services. You understand that through your use of the Services you consent to the collection and use (as set forth in the Privacy Policy) of this information, including the transfer of this information to the United States, Ireland, and/or other countries for storage, processing and use by us and our affiliates.</p>
                </span>
                <br />
                <span >
                    <h2 className='font-bold text-xl'>3. Content on the Services</h2>
                    <p className=''>You are responsible for your use of the Services and for any Content you provide, including compliance with applicable laws, rules, and regulations. You should only provide Content that you are comfortable sharing with others.
                        <br /><br />
                ...
                <span >
                    ...
                    <p className=''>You may need to create an account to use some of our Services. You are responsible for safeguarding your account, so use a strong password and limit its use to this account. We cannot and will not be liable for any loss or damage arising from your failure to comply with the above.
                    <br /><br />
                ...
                <span >
                    ...
                    <p className=''>By using the Services you agree that Manifest Tech, its parents, affiliates, related companies, officers, directors, employees, agents representatives, partners and licensors, liability is limited to the maximum extent permissible in your country of residence.</p>
                </span>
            </section>
            <br /><br />
