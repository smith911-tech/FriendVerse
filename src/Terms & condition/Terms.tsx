      ...
      <section className="px-2 md734:px-[10%]">
        ...
        <span>
          ...
          <p className="">
            ...
            be at least 4 years old, to use the Services. If you are accepting
        ...
        <span>
          ...
          <p className="">
            Our{" "}
            <Link className="text-[#117DD5]" to="/PrivacyPolicy">
              {" "}
              Privacy Policy{" "}
            </Link>
            ...
            for storage, processing and use by us and our affiliates.
          </p>
        </span>
        <br />
        <span>
        ...
        <span>
          ...
          <p>
            ...
            conditions for such Content use. Such additional uses by us, or
        ...
        <span>
          ...
          <p className="">
            By using the Services you agree that Manifest Tech, its parents,
