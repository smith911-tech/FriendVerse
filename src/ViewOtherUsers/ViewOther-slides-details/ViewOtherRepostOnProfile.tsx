                                    ...
                                    <aside className="flex">
                                        <section>
                                            {PersonalData.profileImage === "" ? (
                                                <Link to={`${userid !== post.author ? `/User/${PersonalData.username}` : '/Profile'}`}>
                                        ...
                                        <span>
                                            <Link to={`${userid !== post.author ? `/User/${PersonalData.username}` : '/Profile'}`} className=' ml-2 text-sm font-medium flex hover:underline select-none '>
