      ...
      {data ? (
        ...
        >
          <section
            ...
            className={`flex justify-between px-2 py-2 smm500:px-1 sticky top-14 z-[50] 
          ...
          <div className="relative select-none" onClick={handleBodyClick}>
            ...
            {data.profileImage === "" ? (
              <div
                className={` ${
                  isInputClicked ? " brightness-[0.2]" : " brightness-100"
                } text-8xl absolute left-4 -translate-y-1/2 rounded-full  smm500:text-[80px] smm500:left-1 first-letter:
                            ${
                              theme
