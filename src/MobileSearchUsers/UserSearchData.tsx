...
export default function UserSearchData({ SuggestData }: Props) {
  ...
  return (
    <main>
      <header
        className={`shadow-sm py-3 px-2 flex gap-2
      ...
      >
        ...
        <input
          type="text"
          className={`w-full h-9 outline-none rounded-xl px-3
                ${theme ? "bg-[#1b1d21]" : " bg-[#f0f2f5]"}
                `}
          placeholder="Search FriendVerse"
          value={searchTerm}
      ...
      {searchTerm && (
        <div
          className={`absolute  w-full mt-1  shadow z-10 -ml-2 overflow-y-auto overflow-x-hidden ${
              ...
              .map((data: any) => (
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      <p className="text-left font-semibold text-ellipsis flex">
                        {data.fullName}
                        {data && data.Verify && (
                      ...
                      <p
                        className={`text-sm text-left ${
                          theme ? "text-[#ffffffd4]" : "text-[#000000a9]"
                        }`}
                      >
