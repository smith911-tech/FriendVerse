        ...
        <main className="bg-[#1B1D21] h-[120vh] px-[29px] py-[61px] text-white w-full">
            <section className="bg-[black]  px-4 pb-28 sm500:w-[450px] block mx-auto my-0 md734:w-[80%] md734:pb-36 lg1440:w-[1000px] changePageanimation">
                ...
                <div className='select-none'>
                    ...
                    <h2 className='text-center font-bold font-sans pb-9 mt-[-20px] md734:text-3xl'>Sign In with Friend Verse</h2>
                </div>
                {/* End of logo */}
                <form action="">
                    <section className='flex flex-col justify-center lg1280:flex-row '>
                        {/* email, phone number and password input */}
                    <div className='flex flex-col lg1280:w-[49%]'>{changeInput ? (
                    ...
                    {changeInput  ? (
                    <p onClick={HandleChangeInput} className='text-right mb-4 text-[#117DD5] cursor-pointer font-seri font-semibold  md734:text-center md734:ml-60  lg1280:text-right lg1280:mr-3 text-sm select-none'>Use Phone Number instead</p>
                    ) :  (
                    <p onClick={HandleChangeInput} className='text-right mb-4 text-[#117DD5] cursor-pointer font-seri font-semibold  md734:text-center md734:ml-60  lg1280:text-right lg1280:mr-3 text-sm select-none '>Use Email address instead</p>
                    )}
                    ...
                    <button className='block mx-auto my-0 py-2 px-10  text-black bg-[#D9D9D9] rounded-[30px] font-sans font-bold select-none'>Sign In</button>
                </form>
                {/* end of email, phone number and password input */}
                <section className='select-none'>
                    <Link to="/Forgotpassowrd">
                    <button className='block mx-auto my-7 border border-white border-solid py-1 rounded-[40px] px-6 font-bold lg1280:border-none lg1280:text-[#117DD5]'>Forget password?</button>
                    </Link>
                    <p className='text-center font-bold '>Dont have an Account? 
