...
export default function Repost({ post }: Props) {
  ...
  return (
    <button
      onClick={isRepost ? handleUnRepost : handleRepost}
      className={`flex mt-1 w-[33%] justify-center py-[7px] rounded gap-1  outline-none
                ${
                  theme
                    ? "hover:bg-[#ffffff3c] text-[#ffffffd3]"
                    : "hover:bg-[#0000004f] text-[#000000b7]"
                }`}
    >
      <span
        className={`text-2xl  
