                  ...
                  {comment.author && (
                    <article className="py-4 px-2 flex gap-2 w-full">
                      ...
                      <aside className="w-[84%] md734:w-[90%]">
                        <main
                          className={` pt-1 px-2 rounded-r-xl rounded-b-xl relative
                                                ${
                                                  theme
                                                    ? "bg-[#1b1d21]"
                                                    : "bg-[#f0f2f5]"
                        ...
                        >
                          <div className="flex justify-between">
                            <section className="flex gap-1">
                              ...
                              <p className=" text-xs">
                                {formatPostDate(comment.time)}
                              </p>
                            </section>
                            <DeleteCommentPop comment={comment} post={post} />
                          </div>
                          <p
                            className={` text-xs ml-2 text-[#0000009c] -mt-1 pb-4 select-none ${
                              theme ? "text-[#ffffff91]" : "text-[#0000009c] "
                            }`}
                          >
                            {comment.author.bio}
                          </p>
                          <p className="text-sm ml-2 pb-2 break-words">
                            {comment.Comment}
                          </p>
                        ...
                        <button
                          ...
                          className={`flex gap-1 mt-1 outline-none text-sm font-medium text-[#0000007f] ml-4
                                                ${
                                                  theme
                                                    ? "text-[#ffffff91]"
                                                    : "text-[#0000007f] "
