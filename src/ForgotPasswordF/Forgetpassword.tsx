        ...
        <main className="bg-[#1B1D21] h-[100vh] px-[29px] py-[61px] text-white w-full">
            <section className="bg-[black]  px-4 pb-28 sm500:w-[450px] block mx-auto my-0 md734:w-[600px] md734:pb-30  changePageanimation relative">
                ...
                <div className='select-none'>
                    <img className='w-[100px] block mx-auto my-0 md734:w-[130px] ' src={Logo} alt="" />
                    <h2 className='text-center font-bold font-sans pb-9 mt-[-20px] md734:text-2xl'>Forgot Password</h2>
                </div>
                <section>
                    {changeInput ? (
                    ...
                    <button className="block mx-auto my-0 mt-4 py-2 px-10  text-black bg-[#D9D9D9] rounded-[30px] font-sans font-bold select-none">Submit</button>
                </section>
                {/* End of logo */}
            </section>
        </main>
