        ...
        <main className="bg-[#1B1D21] h-[100vh] px-[29px] py-[61px] relative  w-full">
            <section className="bg-[black]  px-4 pb-28 sm500:w-[450px] block mx-auto my-0 md734:w-[600px] md734:pb-30 ">
                ...
                <div className='select-none'>
                    ...
                    <h2 className='text-center font-bold font-sans pb-9 mt-[-20px] md734:text-2xl text-white'>OTP Verfication</h2>
                </div>
                <h2 className="text-white text-center mb-3 md734:text-lg font-normal font-sans select-none">Enter OTP:</h2>
                ...
                <button className="block mx-auto my-0 mt-10 py-2 px-10  text-black bg-[#D9D9D9] rounded-[10px] font-sans font-bold select-none hover:bg-[#117DD5]  hover:text-white hover:transition">Verify</button>
                </section>
        </main>
    );
};
