...
export default function Privacy() {
    ...
    return (
        ...
        >
            <nav
                className={` ${LightdarkM ? "bg-[white]  color-Toggle" : "bg-[black]  color-Toggle"
                    } flex fixed w-full shadow-2xl md734:pt-6 py-4 px-3 md734:px-6 justify-between`}
            >
                <div
                    className={`flex gap-1  font-serif ${LightdarkM ? "text-black color-Toggle" : "text-white color-Toggle"
                        }`}
                >
                    <img
                        src={Logo}
            ...
            <section className="px-2 md734:px-[10%]">
                ...
                <br />
                <p className={`${LightdarkM ? "text-[#00000099]" : "text-[#ffffffc9]"}`}>
