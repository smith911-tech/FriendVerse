  ...
  return (
    <section className="flex flex-col mt-8  md734:px-24 font-Inter">
      ...
      <p className="text-[#ffffff9b] text-sm font-normal">
        Friend Verse utilizes this information to tailor your experience. Your
        web browsing history will never be saved alongside your name, email, or
        phone number.
      </p>
      <br />
      <p className="text-[#ffffff9b] text-sm font-normal">
        ...
        <Link
          target="blank"
          to="/T&C"
          className="text-[#117DD5] cursor-pointer"
        >
          {" "}
          Terms,{" "}
        </Link>
        ...
        . Friend Verse may use your contact information, including your email
