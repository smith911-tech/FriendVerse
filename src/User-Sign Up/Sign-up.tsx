      ...
      <section className="bg-[black]  px-4 pb-28 sm500:w-[450px] block mx-auto my-0 md734:w-[680px] md734:pb-36 relative changePageanimation">
        ...
        >
          <button
            ...
            className={`block mx-auto my-0 py-2  text-black bg-[#D9D9D9] rounded-[30px] font-sans font-bold select-none ${
              section === 1 ? "bg-[#d9d9d952]" : "bg-[#D9D9D9]"
          ...
          {section !== 3 ? (
            ...
            <button
              ...
              className={`block mx-auto my-0 py-2 px-10  text-white  rounded-[30px] font-sans font-bold select-none ${
                isChecked ? "bg-[#117DD5]" : "bg-[#117dd554]"
              }`}
            >
              {loader ? (
                <ColorRing
