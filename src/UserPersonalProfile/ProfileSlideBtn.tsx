        ...
        <Slider {...settings}>
          <div>
            <div
              ...
              className={`  w-[80%] py-2 ease-in-out transition duration-200 outline-none ${
                theme ? "hover:bg-[#ffffff62]" : "hover:bg-[#00000052]"
              } cursor-pointer 
                        ${
                          clicked.Post
          ...
          <div>
            <div
              onClick={() => handleClick("impression")}
              className={`  w-[80%] py-2 ease-in-out transition duration-200 outline-none ${
                theme ? "hover:bg-[#ffffff62]" : "hover:bg-[#00000052]"
              } cursor-pointer
                    ${
