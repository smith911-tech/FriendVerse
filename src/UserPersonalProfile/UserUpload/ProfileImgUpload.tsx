  ...
  return (
    <>
      {!profileImg ? (
        ...
        <div
          className={` text-7xl absolute left-4 -translate-y-1/2   rounded-full  smm500:text-[80px] smm500:left-1 
                ${
                  theme
        ...
        >
          ...
          <label
            htmlFor="ProfileImg"
            className=" absolute top-1/4 cursor-pointer text-[#fff] text-3xl left-[20%] bg-[#0000008b] px-2 py-2 rounded-2xl brightness-200"
          >
        ...
        <div className="w-24 h-24 rounded-full absolute left-4 -translate-y-1/2 border border-white object-contain bg-white smm500:h-20 smm500:w-20 smm500:left-1 ">
          ...
          <label
            htmlFor="ProfileImg"
            className=" absolute top-1/4 cursor-pointer text-[#ffffff9c] text-3xl left-1/4 bg-[#0000008b] px-2 py-2 rounded-2xl brightness-200"
          >
            <abbr title="Upload Image">
              <AiOutlineCloudUpload />
            </abbr>
