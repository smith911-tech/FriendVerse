    ...
    <>
      {!coverImg && !userClickedRemoveCover ? (
        ...
        <section className="relative">
          ...
          <label
            htmlFor="coverimg"
            className=" absolute top-2/4 cursor-pointer text-[#ffffffc8] text-4xl left-[45%] bg-[#0000008b] px-2 py-2 rounded-2xl"
          >
        ...
        <section className="relative">
          ...
          <label
            htmlFor="coverimg"
            className=" absolute top-2/4 cursor-pointer text-[#ffffffc8] text-3xl left-1/3 bg-[#0000008b] px-2 py-2 rounded-2xl"
          >
            <abbr title="Upload Image">
              <AiOutlineCloudUpload />
            </abbr>
          ...
          <div
            className=" absolute top-2/4 cursor-pointer text-[#ffffffc8] text-2xl right-1/3 bg-[#0000008b] px-2 py-2 rounded-2xl"
