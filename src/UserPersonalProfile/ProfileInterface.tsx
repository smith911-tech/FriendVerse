    ...
    <main>
      <section className="relative">
        {userData ? (
          ...
          >
            <section
              className={`flex justify-between px-2 py-2 smm500:px-1 sticky top-16 z-[50] ${
                theme ? "bg-black" : "bg-white "
              }`}
            >
              <Link to="/Home">
                <div
                  className={`text-3xl top-1 left-1 cursor-pointer 
                                ${
                                  theme
                                    ? "text-[#ffffffe2]"
                                    : "text-[#0000008e]"
              ...
              <Link to="/Profile/Settings">
                <div
                  className={`text-3xl top-1 right-1 cursor-pointer 
                                    ${
                                      theme
                                        ? "text-[#ffffffe2]"
                                        : "text-[#0000008e]"
            ...
            >
              <div className="relative select-none">
                ...
                {userData.profileImage === "" ? (
                  <div
                    className={`text-8xl absolute left-4 -translate-y-1/2   rounded-full  smm500:text-[80px] smm500:left-1 
                                    ${
                                      theme
