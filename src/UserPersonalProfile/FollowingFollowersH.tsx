    ...
    return(
        ...
        ${theme ? "bg-black" : "bg-white"}`}>
            <section className='flex px-2 gap-5'>
                <Link to='/Profile' className={`text-2xl m-2 p-2 rounded-full transition-all cursor-pointer 
            ...
            <section className='flex gap-2 px-2 mb-1'>
                <Link to='/Followers' className={`w-1/2 mt-2  py-3 text-center font-semibold transition-all 
                ${theme ? "hover:bg-[#ffffff5b]" : " hover:bg-[#0000004e]"}`}>
                    <NavLink to='/Followers' className='ProfileActiveF pb-1'>
                        Followers
                    </NavLink>
                </Link>
                <Link to='/Following' className={`w-1/2 mt-2  py-3 text-center font-semibold transition-all 
                ${theme ? "hover:bg-[#ffffff5b]" : " hover:bg-[#0000004e]"}`}>
